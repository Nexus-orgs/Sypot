...
const mockEvents = [
  {
    ...
    description:
      'Join us for an amazing outdoor music festival featuring top artists and local bands. Food trucks, art installations, and great vibes!',
    date: 'Aug 15',
    time: '6:00 PM',
  ...
  },
  {
    ...
    description:
      'Network with fellow entrepreneurs and learn about the latest trends in tech startups. Includes dinner and drinks.',
    date: 'Aug 18',
    time: '7:30 PM',
  ...
  },
  {
    ...
    description:
      'Start your weekend with a refreshing yoga session in the beautiful morning light. All levels welcome!',
    date: 'Aug 20',
    time: '8:00 AM',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.categoriesContainer}>
        ...
        <View style={styles.categories}>
          {['All', 'Music', 'Sports', 'Business', 'Wellness', 'Food'].map(
            category => (
