...
const EventDetailsScreen = ({ navigation, route }) => {
  ...
  const event = route?.params?.event || {
    ...
    maxAttendees: 500,
    description:
      'Join us for an unforgettable evening of live music featuring top artists from around the world. This outdoor festival will feature multiple stages, food trucks, and art installations. Come experience the magic of summer nights with great music and amazing people!',
    highlights: [
      '5 Live Bands',
      'Food & Drinks',
      'Art Installations',
