...
const TestMenuScreen = ({ navigation }) => {
  const screens = [
    ...
    { name: 'OnboardingInterests', title: 'Onboarding - Interests', screen: 'OnboardingInterests' },
    { name: 'ForgotPassword', title: 'Forgot Password', screen: 'ForgotPassword' },
    { name: 'Achievements', title: 'Achievements / Badges', screen: 'Achievements' },
    { name: 'OrganizerDashboard', title: 'Organizer Dashboard', screen: 'OrganizerDashboard' },
    { name: 'TicketPurchase', title: 'Ticket Purchase', screen: 'TicketPurchase' },
  ];
          ...
          >
            <View style={styles.menuItemContent}>
              ...
              <View style={styles.menuItemTextContainer}>
                ...
                <Text style={styles.menuItemScreen}>Navigate to: {screen.screen}</Text>
              </View>
            </View>
