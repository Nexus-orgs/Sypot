      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.activitySection}>
          ...
          <View style={styles.activityCard}>
            <Text style={styles.activityText}>Attended "Summer Music Festival"</Text>
            <Text style={styles.activityDate}>2 days ago</Text>
          </View>
          <View style={styles.activityCard}>
            <Text style={styles.activityText}>Saved "Tech Conference 2024"</Text>
            <Text style={styles.activityDate}>5 days ago</Text>
          </View>
          <View style={styles.activityCard}>
            <Text style={styles.activityText}>Created event "Yoga in the Park"</Text>
