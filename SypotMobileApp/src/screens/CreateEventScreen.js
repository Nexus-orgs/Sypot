...
const CreateEventScreen = ({ navigation }) => {
  ...
  const categories = ['Music', 'Sports', 'Art', 'Food', 'Tech', 'Business', 'Outdoor', 'Social'];

  const CameraIcon = () => (
    <Svg width={32} height={32} fill={theme.colors.gray[400]} viewBox="0 0 256 256">
  ...
  const LocationIcon = () => (
    <Svg width={20} height={20} fill={theme.colors.gray[500]} viewBox="0 0 256 256">
