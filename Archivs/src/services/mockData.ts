...
export const mockEvents: Event[] = [
  {
    ...
    description: 'Join us for the biggest music festival of the summer! Featuring top artists from around the world, food trucks, and amazing vibes. Don\'t miss this incredible experience!',
  ...
  },
  {
    ...
    description: 'Explore the future of technology with industry leaders, startups, and innovators. Networking sessions, keynote speeches, and hands-on workshops.',
  ...
  },
  {
    ...
    description: 'Discover local flavors and artisan crafts at our monthly food market. Over 50 vendors featuring organic produce, handmade treats, and unique culinary experiences.',
  ...
  },
  {
    ...
    description: 'Join our weekly marathon training sessions! Perfect for all skill levels. Professional coaches, nutrition guidance, and a supportive community.',
  ...
  },
  {
    ...
    description: 'Celebrate the opening of our new contemporary art exhibition featuring local artists. Wine reception, artist talks, and exclusive previews.',
  ...
  },
  {
    ...
    description: 'Connect with local professionals in a relaxed atmosphere. Great for making new connections, sharing ideas, and building your network.',
...
export const mockBusinesses: Business[] = [
  {
    ...
    description: 'Upscale rooftop bar with panoramic city views. Perfect for cocktails and networking events.',
  ...
  },
  {
    ...
    description: 'Modern coworking space with state-of-the-art facilities. Hosts tech meetups and workshops.',
  ...
  },
  {
    ...
    description: 'Local coffee shop featuring rotating art exhibitions and live music performances.',
...
export const getMockEvents = (category?: string, limit?: number): Promise<Event[]> => {
